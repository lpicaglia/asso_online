...
<div class="col-md-9">	
	<form action="" method="post" id="form_registration" enctype="multipart/form-data">
			<input type="hidden" name="page" value="modif_profil" />
...
// =================================================================================
	...
	$("#logo").fileinput({
		initialPreview: [
			"<img src='<?= $asso['logo_asso'];?>' class='file-preview-image' alt='Unknown' title='Unknown'>"
		],
